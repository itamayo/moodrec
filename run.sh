javac org/ehu/VectorSpaceModel.java
javac org/ehu/Bkt.java
javac -cp .:./libs/mongodb-driver-core-3.4.2.jar:./libs/bson-3.4.2.jar:./libs/mongodb-driver-3.4.2.jar:org.ehu.Bkt:org.ehu.VectorSpaceModel org/ehu/DBInterface.java
javac -cp .:./libs/nanohttpd-2.3.2-SNAPSHOT.jar:./libs/nanohttpd-nanolets-2.3.2-SNAPSHOT.jar:org.ehu.Bkt:org.ehu.VectorSpaceModel -Xlint:deprecation org/ehu/HttpServer.java
